...
function adminRender() {
  ...
  <img
            ...
            alt="${alt} "
          />
          <div class="div--admin flex">
            <p class="admin--titulo flex p5">
              <span class="p6">Titulo</span>
              <span>${nombre} </span>
            </p>
            <p class="admin--descrip flex p4">
              <span class="p6">Descripcion</span>
              <span> ${descripcion} </span>
            </p>
            <div class="admin--div--interno flex">
              <p class="admin--categoria flex p4">CATEGORIA&nbsp;:&nbsp;&nbsp;<span> ${categoria} </span></p>
              <p class="admin--tam flex p4">TAMAÑO&nbsp;:&nbsp;&nbsp; <span>${tamano}</span></p>
